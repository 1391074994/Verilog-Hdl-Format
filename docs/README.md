...
5. verilog代码常用片段。
6. verilog代码定义变量悬停显示。
7. 代码错误检查:加入[Verilog-HDL/SystemVerilog/Bluespec SystemVerilog](https://github.com/mshr-h/vscode-verilog-hdl-support)的linter(verilog语法检测).
...
9. incrementSelection的功能：使用多个游标进行递增、递减或反向选择
...
## Preface
- Note m: When highlighting code, you need to switch the color theme to: Dark+
- Lifting ᐋ: If you have any good suggestions for improvement, please leave me a message. 𞤺QQ: 1391074994  desprésQQ group: 819816965
